...
const SubCategoryProducts = () => {
  ...
  useEffect(() => {
    ...
    fetchData(
      `https://kidsshopapi.electroshop24.ir/api/v2/list-subcategory-products/${subCategoryCode}?product_page=${product_page}${
  ...
  return (
    <div className="relative w-full min-h-[65vh] grid grid-cols-12 justify-center items-start gap-2 py-4 xl:py-6 xl:gap-4">
      ...
      >
        <img
          src={`https://kidsshopapi.electroshop24.ir/subCategory-images/webp/${subcategory?.PicName}.webp`}
      ...
      "
          ...
          <p className="font-EstedadMedium tracking-wide leading-loose 
          p-1.5
          md:text-sm md:p-2
      ...
      {isModal && (
        ...
        >
          ...
          <ProductSearch
            search={search}
            page={`sub-category-products/${subCategoryCode}`}
          />
          {sizes?.length > 0 && (
            <SizeFilter
              sizes={sizes}
              ...
              products?.links?.map((link, idx) => (
                <button
                  ...
                  onClick={() => {
                    navigate(
                      link?.url.replace(
                        `https://kidsshopapi.electroshop24.ir/api/v2/list-subcategory-products/${subCategoryCode}`,
