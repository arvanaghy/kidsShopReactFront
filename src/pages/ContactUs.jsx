...
const ContactUs = () => {
  ...
  if (pathname === "/contact-us") {
    return (
      <>
        <div className="relative ">
          ...
          <MyMap setDestinationInfo={setDestinationInfo} />
        </div>
        <form
          onSubmit={(e) => handleSubmit(e)}
    ...
    return (
      <div className="col-span-12  lg:col-span-6 flex flex-col justify-center items-center  font-EstedadMedium w-full ">
        <form
          // onSubmit={(e) => handleSubmit(e)}
          className="bg-CarbonicBlue-500 w-full lg:rounded-3xl flex flex-col justify-evenly 
          p-3 gap-2
          lg:p-6 lg:gap-3"
        >
          <div className="font-EstedadExtraBold text-center text-sm w-full  mx-auto rounded-2xl lg:text-xl 2xl:text-2xl  2xl:py-6 py-2 leading-relaxed text-white">
            برای دریافت مشاوره رایگان فرم زیر را پر کنید
          </div>
          <div>
            <div className="flex flex-row justify-between gap-4">
              <input
                onChange={(e) => setName(e.target.value)}
                value={name}
                className=" w-full py-3  bg-white/60 rounded-xl shadow-lg placeholder:text-white placeholder:indent-8 font-EstedadMedium placeholder:font-EstedadMedium  duration-200 indent-4"
                type="text"
                name="firstname"
                placeholder="نام و نام خانوادگی"
              />
          ...
          <button
            className="w-fit py-3 px-6 mx-auto text-white bg-Teal-500/50 font-EstedadExtraBold rounded-xl shadow-2xl border border-Teal-500/80 duration-200 hover:scale-105 text-xs lg:text-lg"
            type="submit"
          >
            {isPending ? (
