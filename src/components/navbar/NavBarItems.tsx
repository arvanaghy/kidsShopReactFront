          ...
          {item.subItems && item.subItems.length > 0 && dropDown && (
            <div className="relative w-full" ref={categoryRef}>
              {isPending ? (
                ...
                <div
                  className="absolute md:w-[85vw] md:top-14 md:px-1.5 py-6 lg:w-[90vw] lg:top-8 lg:px-2 xl:w-[80vw] xl:top-8 xl:px-4 2xl:w-[85vw] 2xl:top-8 2xl:px-6 z-50 text-center bg-gray-100 font-EstedadLight text-gray-600 grid grid-cols-12 items-center justify-center shadow-md md:rounded-b-lg md:rounded-t-none xl:rounded-lg"
                >
                  <div
